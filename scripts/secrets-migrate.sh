...
# NOTE (2026-07-17 reconciliation): SYNOLOGY_PASSWORD/UNIFI_API_KEY/HOMEASSISTANT_TOKEN
# point at the CORRECT vault items (DSM1813: Homelab / Homelab MCP API Key /
# Home Assistant: Claude Token) — an earlier by-name guess picked the wrong ones.
# PROXMOX_TOKEN_SECRET/GITHUB_PACKAGES_PAT/PANGOLIN_API_KEY are NOT in the vault at
# all (they lived only in secrets.env) → sourced as 'local'.
MAP=$(cat <<'EOF'
SYNOLOGY_PASSWORD|pw|b2decfac-1631-462d-9621-b45b009727e1
UNIFI_API_KEY|pw|f788a499-0ad3-4014-83f3-b45900267227
...
HOMEASSISTANT_TOKEN|pw|5677521b-3541-409f-a829-b46500982c20
...
PROXMOX_TOKEN_SECRET|local|PROXMOX_TOKEN_SECRET
GITHUB_PACKAGES_PAT|local|GITHUB_PACKAGES_PAT
PANGOLIN_API_KEY|local|PANGOLIN_API_KEY
EOF
)
