...
```bash
# Using curl
bash <(curl -fsSL https://raw.githubusercontent.com/ChrisonSimtian/Homelab/main/src/Proxmox/SCRIPT_NAME.sh)

# Using wget
bash <(wget -qO- https://raw.githubusercontent.com/ChrisonSimtian/Homelab/main/src/Proxmox/SCRIPT_NAME.sh)
```

For PowerShell scripts:

```bash
pwsh -c "Invoke-Expression (Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/ChrisonSimtian/Homelab/main/src/Proxmox/SCRIPT_NAME.ps1' -UseBasicParsing).Content"
```
